...
function CyberChess3D() {
    ...
    useEffect(() => {
        ...
        const cyan = new THREE.Color(0x2ffcff);
        const cyanBright = new THREE.Color(0xb9ffff);
        ...
        hologramCanvas.width = 256;
        hologramCanvas.height = 256;

        const hctx =
            hologramCanvas.getContext("2d");
